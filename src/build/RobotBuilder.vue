<template>
  <div class="content">
    ...
    <div class="middle-row">
      <div class="left part">
        <img alt="arm-art image" :src="selectedRobot.leftArm.src" title="left arm" />
        <button @click="selectPreviousLeftArm()" class="prev-selector">&#9650;</button>
        <button @click="selectNextLeftArm()" class="next-selector">&#9660;</button>
      </div>
      <div class="center part">
        <img alt="torso image" :src="selectedRobot.torso.src" title="left arm" />
        <button @click="selectPreviousTorso()" class="prev-selector">&#9668;</button>
        <button @click="selectNextTorso()" class="next-selector">&#9658;</button>
      </div>
      <div class="right part">
        <img alt="arm dual image" :src="selectedRobot.rightArm.src" title="left arm" />
    ...
    <div class="bottom-row">
      <div class="bottom part">
        <img alt="base image" :src="selectedRobot.base.src" title="left arm" />
